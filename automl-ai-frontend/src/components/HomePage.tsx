...
export default function HomePage({ onEnter }: Props) {
  return (
    <div className="bg-black text-white min-h-screen overflow-x-hidden overflow-y-auto scroll-smooth">
      
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center py-3 px-6">
        
        {/* Animated Logo */}
        <motion.div
          initial={{ opacity: 0, scale: 0.8, rotate: -10 }}
          animate={{ opacity: 1, scale: [1, 1.1, 1], rotate: 0 }}
          transition={{
